...
#            print("node already in the graph", node.get_name())
...
#            total,outdoor = edge.get_total_distance(), edge.get_outdoor_distance()
#            dest_list = [dest,(total,outdoor)]
#            self.edges[src].append(dest_list)
